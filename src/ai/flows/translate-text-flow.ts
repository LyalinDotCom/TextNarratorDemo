...
const TranslateTextInputSchema = z.object({
  ...
  targetLanguage: z.string().describe('The BCP-47 code of the language to translate to.'),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `Translate the following text to the language with BCP-47 code '{{{targetLanguage}}}'.
